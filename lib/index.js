  ...
  _createClass(App, [{
    ...
    * */
    ...
    value: function pushScene(scene) {
      ...
      for (var _i2 = 0, _n = children.length; _i2 < _n; _i2++) {
        var obj = children[_i2];
        obj.ctx = ctx;
        obj.field = field;
...
var Map = exports.Map = function (_Sprite) {
  ...
  _createClass(Map, [{
    ...
    value: function intersect(ex, ey) {
      ...
      for (var i = 0; i < y; i++) {
        for (var t = 0; t < x; t++) {
          if (array[i][t] == 1 && posX + t * width < ex && ex < posX + (t + 1) * width && posY + i * height < ey && ey < posY + (i + 1) * height) {
            return true;
          }
        }
      }
...
var Layer = exports.Layer = function (_Group2) {
  ...
  _createClass(Layer, [{
    ...
    value: function fitToChildren() {
      ...
      for (var _i3 = 0, _n2 = children.length; _i3 < _n2; _i3++) {
